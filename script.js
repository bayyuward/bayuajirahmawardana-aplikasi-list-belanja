...
// tambah event listener ke floating button
...
// tambah event listener ke modal bg
modal_bg.addEventListener('click', () => {
  // sembunyikan kembali
  hideModal();
});

// tambah event listener submit ke addlist form
...
function hideModal() {
  ...
  floating_button.style.backgroundColor = '#bc6c25';
